...
namespace MAOTimelineExtension.VolumeExtensions
{
    ...
    [TrackClipType(typeof(MAOChannelMixerClip))]
    [TrackBindingType(typeof(TimelineExtensionVolumeSettings))]
    public class MAOChannelMixerTrack : TrackAsset
    {
        public override Playable CreateTrackMixer(PlayableGraph graph, GameObject go, int inputCount)
        {
            return ScriptPlayable<MAOChannelMixerMixerBehaviour>.Create(graph, inputCount);
        }
    }
}
